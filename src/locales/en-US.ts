export default {
  ...
  music: {
    ...
    artistCollectionMode: 'Download Artist Collection',
    artistCollectionModeDescription:
      'Choose and download one artist-wide collection. Expand it to verify the albums, EPs, and singles it contains.',
    artistCompletionMode: 'Complete Missing Releases',
    artistCompletionModeDescription:
      'Shows only official albums, EPs, and singles missing from the library. Exact matches are selected by default.',
    ...
    artistCollectionDescription:
      'Searches artist-wide collection torrents. This mode downloads one collection and does not mix in release-by-release supplements.',
    noArtistCollections: 'No artist collections found',
    noArtistCollectionsDescription: 'The selected sites did not return a collection matching this artist.',
    selectedCollectionCoverage: 'Confirmed in selected collection',
    viewCollectionWorks: 'View included releases ({count})',
    collectionWorksUnknown: 'No official albums, EPs, or singles could be confirmed from the torrent file list.',
    coverageConfirmed: 'Confirmed',
    coverageProbable: 'Probable',
    downloadArtistCollection: 'Download collection',
    downloadSelectedCollection: 'Download selected collection',
    ...
    artistCollectionTaskAdded: 'Artist collection task created: {id}',
    artistCompletionTaskAdded: 'Missing releases task created: {id}',
    downloadMissingWorks: 'Download missing releases',
    downloadMissingWorksConfirm: 'Download the selected {count} releases missing from the library?',
    probingCollection: 'Inspecting torrent file list',
    confirmedCoverage: 'Confirmed coverage: {count}/{total} official releases',
    probableCoverage: '{count} more probably covered',
    coveredByCollection: 'Covered by selected collection',
    selectArtistCollection: 'Select artist collection {title}',
    collectionSelected: 'Selected baseline',
    useAsCollectionBaseline: 'Use as collection baseline',
    createArtistAcquisition: 'Create complete works task',
    artistAcquisitionConfirm: 'Submit {collection} collection and {count} missing-release supplements?',
    artistAcquisitionAdded: 'Complete works task created: {id}',
    artistAcquisitionFailed: 'Failed to create the complete works task',
    ...
    resourceState: {
      pending: 'Waiting',
      searching: 'Matching',
      collection_confirmed: 'Covered by collection',
      exact: 'Exact match',
