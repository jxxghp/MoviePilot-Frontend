export default {
  ...
  githubToken: {
    ...
    statusNeedsReauthorization: 'Reauthorization required',
    ...
    copied: 'Copied',
    openGithub: 'Open GitHub verification page',
    openLink: 'Open it here',
    popupBlocked: 'The browser blocked the new window. Use the link below to open GitHub.',
    waiting: 'Waiting for GitHub authorization…',
    clickPoll: 'Click check after authorizing',
  ...
  setting: {
    ...
    system: {
      ...
      aiAgentStatusDisabled: 'Disabled',
      aiAgentStatusEnabled: 'Enabled',
  ...
  dialog: {
    ...
    siteResource: {
      ...
      mostPeers: 'Most Peers',
      resourceCount: '{count} resources',
      noMore: 'All resources loaded',
      more: 'More actions',
      tags: 'Resource tags',
      itemsPerPage: 'Items Per Page',
      noData: 'No Data',
  ...
  plugin: {
    ...
    incompatibleRuntime: 'This plugin declares no support for the free-threaded runtime (v3t).',
  ...
  initialization: {
    ...
    usernameLockedHint: 'Fixed by the configuration file or environment variable and cannot be changed',
