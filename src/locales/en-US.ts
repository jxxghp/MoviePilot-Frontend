export default {
  ...
  setting: {
    ...
    system: {
      ...
      dbBackupManagementHint:
        'Create and verify managed backups. Database restore remains available from the command line while the service is stopped',
      ...
      dbBackupSize: 'Size',
      dbBackupVerification: 'Verification',
      dbBackupActions: 'Actions',
      dbBackupVerify: 'Verify backup',
      dbBackupVerifyName: 'Verify backup {name}',
      ...
      dbBackupValid: 'Valid',
      dbBackupInvalid: 'Invalid',
      dbBackupNotVerified: 'Not verified',
