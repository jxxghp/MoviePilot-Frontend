export default {
  ...
  plugin: {
    ...
    create: 'Create',
    clone: 'Clone',
    cloneSubtitle: 'Create a new clone of {name}, or restore one you uninstalled earlier',
    cloneDescription:
    ...
    cloneNotice:
      "A clone shares the source code with its host but keeps its own configuration, data and logs. A new clone is loaded straight away, while the plugin's own enable switch starts off so you can configure it first.",
    createClone: 'Create Clone',
    cloning: 'Creating clone for {name}...',
    cloneSuccess: 'Plugin clone {name} created successfully!',
    cloneRestoreSuccess: 'Plugin clone {name} restored with its configuration and data intact',
    ...
    versionManage: 'Versions & Instances',
    versionManageTitle: '{name} Versions & Instances',
    versionManageLoadFailed: 'Failed to load version and instance information, please try again later',
    versionManageRefreshFailed:
      'The operation completed, but the version and instance state could not be refreshed. Please retry.',
    instanceVersionUnknown: 'Running (version unavailable)',
    installedVersionsTitle: 'Installed Versions',
    installedVersionsEmpty: 'No installed versions recorded',
    versionColumnVersion: 'Version',
    versionColumnSource: 'Source',
    versionColumnInstalledAt: 'Installed At',
    versionColumnStatus: 'Status',
    versionCurrent: 'Current Version',
    versionRecycle: 'Recycle Old Versions',
    versionRecycleConfirm:
      'This will delete installed version directories no longer referenced by any instance and outside the recent version window. Continue?',
    versionRecycleSuccess: 'Recycled {count} version directories',
    versionRecycleNothing: 'No version directories are eligible for recycling',
    versionRecycleFailed: 'Recycling failed: {message}',
    versionRecycleRemoved: 'Removed versions: {versions}',
    versionRecycleNothingRemoved: 'No versions were removed',
    versionRecycleKeptTitle: 'Kept versions and reasons',
    instancesTitle: 'Instances',
    instancesEmpty: 'No instances',
    instanceHost: 'Host',
    instanceClone: 'Clone',
    instanceVersionNotStarted: 'Not started yet',
    versionFollowCurrent: 'Follow current version',
    versionPinnedOption: 'Pin to a specific version',
    versionPinned: 'Pinned v{version}',
    versionSelectLabel: 'Select version',
    versionSwitchNotice: 'Switching the version binding will stop and restart this instance.',
    versionSwitchSuccess: 'Version binding updated',
    versionSwitchFailed: 'Failed to update version binding: {message}',
    instanceRunning: 'Running',
    instanceStopped: 'Stopped',
    instanceActionOpen: 'Open Config',
    instanceOpenUnavailable: 'Could not load the plugin details for {name}. Refresh and try again.',
    instanceColumnActions: 'Actions',
    instanceActionSwitchVersion: 'Switch Version',
    instanceActionLogLevel: 'Log level',
    purgeScopeConfig: 'Configuration',
    purgeScopePluginData: 'Plugin data',
    purgeScopeOwnDatabase: 'Own database',
    purgeScopeDataDirectory: 'Data directory config/plugins/{id}/',
    instanceActionReset: 'Reset Config and Data',
    instanceActionUninstallHost: 'Uninstall Plugin and All Clones',
    instanceActionUninstallClone: 'Uninstall This Clone',
    instanceResetConfirm:
      "Reset the configuration and data of {name}? This instance's data will be cleared and cannot be recovered.",
    instanceResetSuccess: '{name} has been reset',
    instanceResetFailed: 'Reset failed: {message}',
    instanceUninstallTitle: 'Uninstall {name}',
    uninstallKeepsCloneSettings:
      'Uninstalling removes this clone from the list while keeping its configuration, display name and data. You can bring it back by id from the clone creation dialog.',
    uninstallKeepsHostSettings:
      'Uninstalling deletes the plugin package but keeps its configuration and data, so reinstalling brings the settings back.',
    uninstallCascadeWarning: 'Its clones ({clones}) are uninstalled too, each keeping its own configuration.',
    uninstallAlsoPurgeTitle: 'Also delete (optional)',
    uninstallAlsoPurgeHint:
      'Nothing is deleted by default. Whatever you tick here is really removed and will not come back on restore.',
    uninstallPurgeIrreversible: 'What you ticked will be permanently deleted and will not be there on restore.',
    uninstallConfirm: 'Uninstall',
    uninstallAndPurgeConfirm: 'Uninstall and delete',
    instanceUninstallSuccess: '{name} has been uninstalled',
    instanceUninstallFailed: 'Uninstall failed: {message}',
    cloneVersionStrategy: 'Version Strategy',
    cloneModeCreate: 'New clone',
    cloneModeRestore: 'Restore uninstalled ({count})',
    cloneRestoreHint:
      'Pick a clone you uninstalled earlier to bring it back together with the configuration it had. Clones still in place are not listed here.',
    cloneRestorableHasConfig: 'Has configuration',
    cloneRestorableHasData: 'Has data',
    cloneRestoreConfirm: 'Restore this clone',
    cloneVersionFollow: 'Follow the plugin version',
    cloneVersionAnchor: 'Pin a version',
    cloneVersionAnchorUnavailable: 'No version is available to pin, so the clone can only follow the plugin version.',
    cloneVersionNotInstalled: 'Not installed',
    cloneVersionInstalled: 'Installed, ready to pin',
    cloneVersionWillInstall: 'Not installed; it will be installed before the clone is created',
    cloneVersionInstallNotice:
      "Installing v{version} sets it as the plugin's current version, so every instance following the plugin version switches to it.",
    cloneVersionInstallFailed: 'Failed to install v{version}: {message}. The clone was not created.',
    cloneVersionsLoadFailed: 'Failed to load the versions available to pin',
    defaultTargetSet: 'Set as default target',
    defaultTargetClear: 'Clear default target',
    defaultTargetOnlyOneHint: 'Each plugin can have at most one default call target at a time',
    defaultTargetSetSuccess: 'This instance is now the default target',
    defaultTargetClearSuccess: 'Default target cleared for this instance',
    defaultTargetFailed: 'Operation failed: {message}',
    logLevelFollowGlobal: 'Follow global',
    logLevelConfigured: 'Configured: {level}',
    logLevelEffective: 'Effective: {level}',
    logLevelSelectLabel: 'Log level',
    logLevelExpiresLabel: 'Expires at (optional)',
    logLevelExpiresHint: 'Leave empty for no expiration',
    logLevelSetSuccess: 'Log level updated',
    logLevelSetFailed: 'Failed to set log level: {message}',
    logLevelClear: 'Clear override',
    logLevelClearSuccess: 'Log level override cleared, falling back to global level',
