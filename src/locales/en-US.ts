export default {
  ...
  dialog: {
    ...
    transferQueue: {
      ...
      manualReviewRetryWaitHint: 'Confirmed not completed. The task was returned to the background retry queue; check Transfer History for the final result.',
    },
    reorganize: {
      title: 'Organize',
      ...
      overwriteSkippedHint: 'The target already exists and the current overwrite policy skipped this item. Adjust the policy or remove the old file, then retry.',
  ...
  transferHistory: {
    ...
    autoPausedHint: 'Automatic organization is paused. Fix the cause, then retry or delete the failed record and scan again.',
