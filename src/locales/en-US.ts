export default {
  ...
  setting: {
    ...
    directory: {
      ...
      directorySaveOutdated: 'Directory settings changed while saving; save the latest draft again',
      ...
      matchMode: 'Directory Match Mode',
      matchModes: {
        sequential: 'Configuration Order',
        specificity: 'Most Specific First',
      },
      matchModeHints: {
        sequential: 'Preserves existing behavior and selects the first eligible directory.',
        specificity: 'Prefers exact categories, then media types, then wildcard directories.',
      },
      routePreview: {
        title: 'Route Preview',
        subtitle: 'Check routing with the current unsaved category and directory configuration.',
        movie: 'Movie',
        tv: 'TV Show',
        mediaType: 'Media Type',
        mediaTitle: 'Title',
        year: 'Year',
        providedCategory: 'Provided Category',
        genreIds: 'Genre IDs',
        genreIdsPlaceholder: 'For example: 16, 10764',
        originalLanguage: 'Original Language',
        ...
        includeUnsorted: 'Include directories without monitoring enabled',
        run: 'Preview Route',
        requestFailed: 'Route preview failed: {message}',
        empty: 'Enter a media snapshot to preview its route.',
        result: 'Current Mode Result',
        noRoute: 'No directory satisfies the current conditions.',
        noRouteShort: 'No matching directory',
        noCategory: 'Uncategorized',
        comparison: 'Mode Comparison',
        diagnostics: 'Configuration Diagnostics',
        categoryRules: 'Category Rules',
        noCategoryRules: 'There are no category rules for this media type.',
        directoryCandidates: 'Directory Candidates',
        noCandidates: 'There are no directory candidates to display.',
        matched: 'Matched',
        ...
        warnings: {
          unconditional_category_not_last: 'An unconditional fallback is not last, making later rules unreachable.',
          multiple_category_matches: 'Multiple category rules match; the first rule is used.',
          generic_before_specific: 'A generic directory matches before a later exact directory.',
          unknown_media_category: 'A directory references a category that is absent from this configuration.',
          duplicate_directory_conditions: 'Identical directory conditions point to different targets.',
          provided_category_conflict:
            'The provided category differs from automatic classification and takes precedence.',
          no_matching_directory: 'No directory satisfies the current media and path constraints.',
        },
        reasons: {
          source_path_scope_mismatch: 'The source path is outside this directory monitoring scope.',
          monitor_disabled: 'Monitoring is disabled for this directory.',
          source_storage_mismatch: 'The source storage does not match.',
          target_storage_mismatch: 'The target storage does not match.',
          destination_path_mismatch: 'The requested destination is outside this directory.',
          media_rule_mismatch: 'The media type or category rule does not match.',
        },
      },
    },
    category: {
      ...
      saveOutdated: 'The configuration changed while saving. The latest draft was kept; save it again.',
