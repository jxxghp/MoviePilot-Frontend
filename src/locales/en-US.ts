export default {
  ...
  login: {
    ...
    oidcUnbound: 'This OIDC account is not bound to any user. Please login with username and password first, then bind your OIDC account',
  ...
  user: {
    ...
    confirmUnbindOidc: 'Are you sure you want to unbind your OIDC account? You will not be able to login with OIDC after unbinding.',
  ...
  setting: {
    ...
    oidc: {
      ...
      disabledStatus: 'OIDC login is not enabled, turn on the switch and fill in the Issuer URL to enable',
      ...
      guideStep5: '5. Logged-in users can bind/unbind OIDC accounts from the user menu',
    },
    words: {
