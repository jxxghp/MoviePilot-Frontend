export default {
  ...
  plugin: {
    ...
    sourceInstalledHint: 'Plugin updates only use the bound trusted source.',
    sourceConflictHint: 'Multiple plugins share this ID. Choose an installation source.',
    sourceSelectionRequired: 'Selection required',
    sourceBindingHint: 'This plugin has no update source yet. Choose a repository you trust.',
    trustedUpdateSource: 'Update source',
    currentPayloadSource: 'Current runtime source',
    ...
    confirmSourceBind:
      'Bind the update source for {name} to {target}. The current version from that source will be installed immediately.',
    ...
    confirmSourceChange:
      'Change the update source for {name} from {current} to {target}. The current version from the target source will be installed immediately.',
