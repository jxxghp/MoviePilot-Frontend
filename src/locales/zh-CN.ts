export default {
  ...
  theme: {
    ...
    glassQualityCssHint: '静态 CSS 材质，资源占用最低，不启用实时流动。',
    ...
    glassMotionStrength: '流动强度',
    glassReflectionStrength: '反射亮度',
    glassTransparencyStrength: '通透度',
    glassOpticalStrengthHint: '通透度控制真实背景占比；流动与反射仅在均衡和高质量档实时生效。',
    glassOpticalStrengthUnavailableHint: '标准档保留通透度，流动与反射数值会在切回实时质量后恢复。',
    purple: '幻紫',
    custom: '附加样式',
    transparency: '透明度',
