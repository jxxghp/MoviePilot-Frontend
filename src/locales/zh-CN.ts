export default {
  ...
  plugin: {
    ...
    create: '创建',
    clone: '分身',
    cloneSubtitle: '为 {name} 新建分身，或恢复之前卸载掉的分身',
    ...
    cloneNotice:
      '分身与本体共享同一份源码，但配置、数据与日志各自独立。新建的分身会立即加载，插件自身的启用开关默认关闭，配置好再打开。',
    createClone: '创建分身',
    cloning: '正在创建 {name} 的分身...',
    cloneSuccess: '插件分身 {name} 创建成功！',
    cloneRestoreSuccess: '插件分身 {name} 已恢复，配置与数据原样回来了',
    ...
    allPlugins: '所有插件',
    versionManage: '版本与实例',
    versionManageTitle: '{name} 版本与实例',
    versionManageLoadFailed: '版本与实例信息加载失败，请稍后重试',
    versionManageRefreshFailed: '操作已完成，但版本与实例状态刷新失败，请手动重试',
    instanceVersionUnknown: '运行中（版本未知）',
    installedVersionsTitle: '已装版本',
    installedVersionsEmpty: '暂无已装版本记录',
    versionColumnVersion: '版本',
    versionColumnSource: '来源',
    versionColumnInstalledAt: '安装时间',
    versionColumnStatus: '状态',
    versionCurrent: '当前版本',
    versionRecycle: '回收旧版本',
    versionRecycleConfirm: '将删除不再被任何实例引用、且不在最近版本窗口内的已装版本目录，确定继续吗？',
    versionRecycleSuccess: '已回收 {count} 个版本目录',
    versionRecycleNothing: '当前没有可回收的版本目录',
    versionRecycleFailed: '回收失败：{message}',
    versionRecycleRemoved: '已删除版本：{versions}',
    versionRecycleNothingRemoved: '没有版本被删除',
    versionRecycleKeptTitle: '保留的版本及原因',
    instancesTitle: '实例',
    instancesEmpty: '暂无实例',
    instanceHost: '本体',
    instanceClone: '分身',
    instanceVersionNotStarted: '尚未启动',
    versionFollowCurrent: '跟随当前版本',
    versionPinnedOption: '钉在指定版本',
    versionPinned: '钉住 v{version}',
    versionSelectLabel: '选择版本',
    versionSwitchNotice: '切换版本绑定会导致该实例停止再启动。',
    versionSwitchSuccess: '版本绑定已更新',
    versionSwitchFailed: '版本绑定更新失败：{message}',
    instanceRunning: '运行中',
    instanceStopped: '已停止',
    instanceActionOpen: '打开配置',
    instanceOpenUnavailable: '未能读取 {name} 的插件信息，请刷新后重试',
    instanceColumnActions: '操作',
    instanceActionSwitchVersion: '切换版本',
    instanceActionLogLevel: '日志等级',
    purgeScopeConfig: '配置',
    purgeScopePluginData: '插件数据',
    purgeScopeOwnDatabase: '自有数据库',
    purgeScopeDataDirectory: '数据目录 config/plugins/{id}/',
    instanceActionReset: '重置配置与数据',
    instanceActionUninstallHost: '卸载插件及全部分身',
    instanceActionUninstallClone: '卸载此分身',
    instanceResetConfirm: '确定要重置 {name} 的配置与业务数据吗？该实例的数据将被清空，且无法恢复。',
    instanceResetSuccess: '{name} 已重置',
    instanceResetFailed: '重置失败：{message}',
    instanceUninstallTitle: '卸载 {name}',
    uninstallKeepsCloneSettings:
      '卸载后这个分身会从列表中移除，它的配置、展示名与业务数据原样保留；之后在「创建分身」里可以按 ID 把它恢复回来。',
    uninstallKeepsHostSettings: '卸载会删除插件包，但它的配置与业务数据原样保留；重新安装后设置会自动回来。',
    uninstallCascadeWarning: '它的分身（{clones}）会被一并卸载，各自的配置同样保留。',
    uninstallAlsoPurgeTitle: '同时清除（可选）',
    uninstallAlsoPurgeHint: '默认一项都不清除。勾选的内容会被真正删除，且无法通过恢复拿回。',
    uninstallPurgeIrreversible: '你勾选的内容将被永久删除，恢复时不会再有它们。',
    uninstallConfirm: '卸载',
    uninstallAndPurgeConfirm: '卸载并清除',
    instanceUninstallSuccess: '{name} 已卸载',
    instanceUninstallFailed: '卸载失败：{message}',
    cloneVersionStrategy: '版本策略',
    cloneModeCreate: '新建分身',
    cloneModeRestore: '恢复已卸载（{count}）',
    cloneRestoreHint: '挑一个之前卸载掉的分身，把它连同当时的配置一起拿回来。已在册的分身不会出现在这里。',
    cloneRestorableHasConfig: '留有配置',
    cloneRestorableHasData: '留有数据',
    cloneRestoreConfirm: '恢复该分身',
    cloneVersionFollow: '跟随本体版本',
    cloneVersionAnchor: '锚定版本',
    cloneVersionAnchorUnavailable: '当前没有可锚定的版本，分身只能跟随本体版本。',
    cloneVersionNotInstalled: '未安装',
    cloneVersionInstalled: '已安装，可直接锚定',
    cloneVersionWillInstall: '未安装，创建分身前会先安装该版本',
    cloneVersionInstallNotice: '安装 v{version} 会把插件的当前版本改为该版本，跟随本体版本的实例会随之切换。',
    cloneVersionInstallFailed: '版本 v{version} 安装失败：{message}，分身未创建',
    cloneVersionsLoadFailed: '读取可锚定版本失败',
    defaultTargetSet: '设为默认调用目标',
    defaultTargetClear: '取消默认调用目标',
    defaultTargetOnlyOneHint: '每个插件同一时间至多一个默认调用目标',
