export default {
  ...
  music: {
    ...
    artistCollectionMode: '下载艺术家大合集',
    artistCollectionModeDescription: '只选择并下载一个艺术家大合集；展开资源可核对其中确认包含的专辑、EP 和单曲。',
    artistCompletionMode: '补全缺失作品',
    artistCompletionModeDescription: '只列出媒体库缺失的官方专辑、EP 和单曲；有精确资源的项目默认选中。',
    discographyLoadFailed: '加载艺术家作品失败',
    artistCollectionResources: '艺术家合集资源',
    artistCollectionDescription: '按艺术家搜索大合集种子；本模式一次只下载一个合集，不再混合提交逐张作品补全。',
    noArtistCollections: '没有找到艺术家大合集',
    noArtistCollectionsDescription: '当前站点或搜索词没有返回符合条件的大合集资源。',
    selectedCollectionCoverage: '选中合集确认覆盖',
    viewCollectionWorks: '查看包含作品（{count}）',
    collectionWorksUnknown: '种子目录中未能确认对应的官方专辑、EP 或单曲。',
    coverageConfirmed: '确认包含',
    coverageProbable: '可能包含',
    downloadArtistCollection: '下载大合集',
    downloadSelectedCollection: '下载选中大合集',
    downloadArtistCollectionConfirm: '确定使用默认下载器下载“{title}”吗？',
    artistCollectionDownloadAdded: '艺术家合集已加入下载',
    artistCollectionTaskAdded: '艺术家大合集任务已创建：{id}',
    artistCompletionTaskAdded: '缺失作品补全任务已创建：{id}',
    downloadMissingWorks: '下载缺失作品',
    downloadMissingWorksConfirm: '将逐项下载选中的 {count} 个媒体库缺失作品，是否继续？',
    probingCollection: '正在解析种子文件清单',
    confirmedCoverage: '已确认覆盖 {count}/{total} 个官方作品',
    probableCoverage: '另有 {count} 个可能覆盖',
    coveredByCollection: '已由选中合集覆盖',
    selectArtistCollection: '选择艺术家合集 {title}',
    collectionSelected: '已选为基线',
    useAsCollectionBaseline: '作为合集基线',
    createArtistAcquisition: '创建完整作品任务',
    artistAcquisitionConfirm: '将提交 {collection} 个合集和 {count} 个缺失补齐资源，是否继续？',
    artistAcquisitionAdded: '艺术家完整作品任务已创建：{id}',
    artistAcquisitionFailed: '创建艺术家完整作品任务失败',
  ...
  setting: {
    classification: {
      ...
      helpButton: '查看自动分类帮助',
      helpTitle: '自动分类使用说明',
      helpDescription: '按下面的顺序完成配置、检查和发布。',
      helpClose: '知道了',
      help: {
        sections: {
          categories: {
      ...
      preview: {
        title: '分类结果预览与匹配说明',
        description: '搜索并选择一条媒体信息，查看它会被分到哪里。预览不会修改当前已发布的规则。',
        run: '预览分类结果',
        modeLabel: '使用哪套规则',
        draftPolicy: '当前编辑中的规则',
        activePolicy: '已发布的规则',
        factsTitle: '媒体信息',
        searchDescription: '不需要手工填写字段；搜索后选择媒体，系统直接使用这条媒体信息进行预览。',
        keyword: '搜索媒体',
      ...
      impact: {
        title: '影响分析',
        description: '读取近期下载和整理记录对应的完整媒体信息，比较当前规则与待发布规则的结果。',
        ...
        analyze: '开始分析',
        scope:
          '最多比较 200 条近期记录并返回 50 条变化示例；无法获取详情的记录会单独列出，分析不会移动文件或修改历史。',
      ...
      control: {
        title: '版本发布与历史',
        description: '发布和回退都以当前版本为准；如果服务器已经被其他操作更新，本地草稿会保留，不会被覆盖。',
