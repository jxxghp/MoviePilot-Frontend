export default {
  ...
  plugin: {
    ...
    sourceInstalledHint: '插件更新只会使用已绑定的可信来源。',
    sourceConflictHint: '检测到多个同名插件，请选择安装来源。',
    sourceSelectionRequired: '需选择',
    sourceBindingHint: '当前插件尚未绑定更新来源，请选择可信仓库。',
    trustedUpdateSource: '更新来源',
    currentPayloadSource: '当前运行来源',
    selectSourceRequired: '请选择插件来源后再安装。',
    bindSource: '绑定来源',
    confirmSourceBindTitle: '确认绑定插件来源',
    confirmSourceBind: '将插件 {name} 的更新来源绑定为 {target}。确认后会立即安装该来源的当前版本。',
    ...
    confirmSourceChange: '将插件 {name} 的更新来源从 {current} 更换为 {target}。确认后会立即安装目标来源的当前版本。',
