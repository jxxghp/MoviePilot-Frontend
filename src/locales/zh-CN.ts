export default {
  ...
  dialog: {
    ...
    subscribeEdit: {
      ...
      bestVersionModeHint: '分集洗版，优先全集；或仅全集',
      bestVersionModeDefault: '跟随系统默认',
      bestVersionModeEpisode: '分集（优先全集）',
      bestVersionModeWholeOnly: '仅全集',
      bestVersionModeEpisodeShort: '分集',
      bestVersionModeWholeOnlyShort: '仅全集',
