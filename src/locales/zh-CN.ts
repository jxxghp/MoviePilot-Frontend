export default {
  ...
  login: {
    ...
    oidcUnbound: '该 OIDC 账号未绑定系统用户，请先使用用户名密码登录后绑定',
    oidcError: 'OIDC 认证失败',
    userInactive: '用户已被禁用',
    loggingIn: '正在登录',
    pleaseWait: '请稍候...',
  ...
  user: {
    ...
    bindOidc: '绑定 OIDC 账号',
    bindOidcSuccess: 'OIDC 账号绑定成功',
    bindOidcFailed: 'OIDC 账号绑定失败',
    unbindOidc: '解绑 OIDC 账号',
    confirmUnbindOidc: '确定要解绑 OIDC 账号吗？解绑后将无法使用 OIDC 登录。',
    unbindOidcSuccess: 'OIDC 账号解绑成功',
    unbindOidcFailed: 'OIDC 账号解绑失败',
  ...
  setting: {
    ...
    oidc: {
      ...
      disabledStatus: 'OIDC 登录未启用，请打开开关并填写签发者 URL 后保存',
      testConnection: '测试连接',
      ...
      guideStep5: '5. 已登录用户可在右上角菜单中绑定/解绑 OIDC 账号',
    },
    words: {
