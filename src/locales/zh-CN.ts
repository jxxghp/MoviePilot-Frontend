export default {
  ...
  plugin: {
    ...
    restartRequiredBadgeHint: '原生依赖已更新，当前插件仍可使用，重启 MoviePilot 后完整生效',
    restartRequiredTitle: '插件更新需重启',
    restartRequiredDescription: '插件「{plugin}」的原生依赖已更新，重启 MoviePilot 后完整生效',
    restartRequiredMultipleDescription: '{count} 个插件的原生依赖已更新，重启 MoviePilot 后完整生效',
