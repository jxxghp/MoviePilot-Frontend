export default {
  ...
  plugin: {
    ...
    instancesTitle: '實例',
    instancesEmpty: '暫無實例',
    instanceColumnId: '實例 ID',
    instanceHost: '本體',
    instanceClone: '分身',
    instanceColumnVersion: '已生效版本',
    instanceVersionNotStarted: '尚未啟動',
    instanceColumnBinding: '版本綁定',
    ...
    instanceColumnRunning: '運行狀態',
    instanceRunning: '運行中',
    instanceStopped: '已停止',
    instanceColumnDefaultTarget: '默認調用目標',
