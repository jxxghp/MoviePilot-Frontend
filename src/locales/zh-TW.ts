export default {
  ...
  dialog: {
    ...
    subscribeEdit: {
      ...
      bestVersionMode: '洗版模式',
      bestVersionModeHint: '分集洗版，優先全集；或僅全集',
      bestVersionModeDefault: '跟隨系統預設',
      bestVersionModeEpisode: '分集（優先全集）',
      bestVersionModeWholeOnly: '僅全集',
      bestVersionModeEpisodeShort: '分集',
      bestVersionModeWholeOnlyShort: '僅全集',
      searchImdbid: '使用 ImdbID 搜索',
      searchImdbidHint: '開啟後使用 ImdbID 精確搜索資源',
