export default {
  ...
  theme: {
    ...
    glassQualityCssHint: '靜態 CSS 材質，資源佔用最低，不啟用即時流動。',
    glassQualityBalancedHint: '共享即時折射，優先平衡流動回饋與 GPU 佔用。',
    glassQualityHighHint: '完整時序流場、擴散細節與內容保護，GPU 佔用更高。',
    glassQualityMobileHint: '移動端始終使用穩定材質，品質選擇僅在桌面端生效。',
    glassMotionStrength: '流動強度',
    glassReflectionStrength: '反射亮度',
    glassTransparencyStrength: '通透度',
    glassOpticalStrengthHint: '通透度控制真實背景占比；流動與反射僅在均衡和高品質檔即時生效。',
    glassOpticalStrengthUnavailableHint: '標準檔保留通透度，流動與反射數值會在切回即時品質後恢復。',
    purple: '幻紫',
    custom: '附加樣式',
    transparency: '透明度',
