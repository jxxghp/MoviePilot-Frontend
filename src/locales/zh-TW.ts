export default {
  ...
  plugin: {
    ...
    sourceInstalledHint: '插件更新只會使用已綁定的可信來源。',
    sourceConflictHint: '偵測到多個同名插件，請選擇安裝來源。',
    sourceSelectionRequired: '需選擇',
    sourceBindingHint: '目前插件尚未綁定更新來源，請選擇可信倉庫。',
    trustedUpdateSource: '更新來源',
    currentPayloadSource: '目前運行來源',
    selectSourceRequired: '請選擇插件來源後再安裝。',
    bindSource: '綁定來源',
    confirmSourceBindTitle: '確認綁定插件來源',
    confirmSourceBind: '將插件 {name} 的更新來源綁定為 {target}。確認後會立即安裝該來源的目前版本。',
    ...
    confirmSourceChange: '將插件 {name} 的更新來源從 {current} 更換為 {target}。確認後會立即安裝目標來源的目前版本。',
