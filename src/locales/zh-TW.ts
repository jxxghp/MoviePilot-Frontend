export default {
  ...
  setting: {
    ...
    directory: {
      ...
      directorySaveOutdated: '保存期間目錄已被繼續修改，請再次保存最新草稿',
      ...
      matchModeHints: {
        sequential: '保持現有行為，使用第一個滿足條件的目錄。',
        specificity: '優先選擇精確類別目錄，其次是媒體類型目錄和通配目錄。',
      },
      routePreview: {
        title: '路由預覽',
        subtitle: '使用目前未保存的分類與目錄設定檢查整理路徑。',
        movie: '電影',
        tv: '電視劇',
        mediaType: '媒體類型',
        mediaTitle: '標題',
        year: '年份',
        providedCategory: '指定類別',
        genreIds: '類型 ID',
        genreIdsPlaceholder: '例如：16, 10764',
        originalLanguage: '原始語言',
        countries: '國家/地區',
        sourceStorage: '來源存儲',
        sourcePath: '來源路徑',
        targetStorage: '目標存儲',
        destinationPath: '指定目標路徑',
        includeUnsorted: '包含未啟用監控整理的目錄',
        run: '開始預覽',
        requestFailed: '路由預覽失敗：{message}',
        empty: '填寫媒體元資料後開始預覽。',
        result: '目前模式結果',
        noRoute: '沒有目錄滿足目前條件。',
        noRouteShort: '無匹配目錄',
        ...
        diagnostics: '設定診斷',
        categoryRules: '分類規則',
        noCategoryRules: '目前媒體類型沒有分類規則。',
        directoryCandidates: '目錄候選',
        noCandidates: '沒有可顯示的目錄候選。',
        matched: '命中',
        notMatched: '未命中',
        selected: '已選擇',
        missingValue: '缺失',
        ...
        warnings: {
          unconditional_category_not_last: '無條件兜底分類不是最後一項，後續規則不可達。',
          multiple_category_matches: '同時命中多條分類規則，實際採用第一條。',
          generic_before_specific: '通用目錄會先於後面的精確目錄命中。',
          unknown_media_category: '目錄引用了目前分類設定中不存在的類別。',
          duplicate_directory_conditions: '存在條件相同但目標不同的目錄設定。',
          provided_category_conflict: '指定類別與自動分類結果不同，目前使用指定類別。',
          no_matching_directory: '沒有目錄滿足目前媒體與路徑約束。',
        },
        reasons: {
          source_path_scope_mismatch: '來源路徑不在該目錄的監控範圍內。',
          monitor_disabled: '該目錄未啟用監控。',
          source_storage_mismatch: '來源存儲不匹配。',
          target_storage_mismatch: '目標存儲不匹配。',
          destination_path_mismatch: '指定目標路徑不屬於該目錄。',
          media_rule_mismatch: '媒體類型或類別條件不匹配。',
        },
      },
    },
    category: {
      ...
      saveOutdated: '保存期間設定已發生變化，已保留最新草稿，請再次保存。',
      loadFailed: '加載分類配置失敗',
