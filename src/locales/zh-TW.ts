export default {
  ...
  subscribe: {
    ...
    maintenance: {
      ...
      searchAllConfirm: '系統會依次搜索目前帳號可存取的全部訂閱，並存取相應站點。訂閱較多時需要一些時間，是否繼續？',
      searchAllStarted: '全部訂閱搜索已安排！',
      searchAllEmpty: '沒有需要搜索的訂閱',
      searchAllAlreadyRunning: '{count} 個訂閱已經在搜索中，請稍候',
      searchAllMixed: '已安排 {queued} 個訂閱搜索，另有 {ongoing} 個正在處理中',
      searchAllScheduled: '已安排 {count} 個訂閱，系統會自動依次搜索',
      refresh: '刷新訂閱資源',
  ...
  plugin: {
    ...
    create: '創建',
    clone: '分身',
    cloneSubtitle: '為 {name} 新建分身，或恢復之前解除安裝掉的分身',
    ...
    cloneNotice:
      '分身與本體共用同一份原始碼，但設定、資料與日誌各自獨立。新建的分身會立即載入，外掛自身的啟用開關預設關閉，設定好再打開。',
    createClone: '創建分身',
    cloning: '正在創建 {name} 的分身...',
    cloneSuccess: '插件分身 {name} 創建成功！',
    cloneRestoreSuccess: '插件分身 {name} 已恢復，設定與資料原樣回來了',
    ...
    allPlugins: '所有插件',
    versionManage: '版本與實例',
    versionManageTitle: '{name} 版本與實例',
    versionManageLoadFailed: '版本與實例信息加載失敗，請稍後重試',
    versionManageRefreshFailed: '操作已完成，但版本與執行個體狀態刷新失敗，請手動重試',
    instanceVersionUnknown: '執行中（版本未知）',
    installedVersionsTitle: '已裝版本',
    installedVersionsEmpty: '暫無已裝版本記錄',
    versionColumnVersion: '版本',
    versionColumnSource: '來源',
    versionColumnInstalledAt: '安裝時間',
    versionColumnStatus: '狀態',
    versionCurrent: '當前版本',
    versionRecycle: '回收舊版本',
    versionRecycleConfirm: '將刪除不再被任何實例引用、且不在最近版本窗口內的已裝版本目錄，確定繼續嗎？',
    versionRecycleSuccess: '已回收 {count} 個版本目錄',
    versionRecycleNothing: '當前沒有可回收的版本目錄',
    versionRecycleFailed: '回收失敗：{message}',
    versionRecycleRemoved: '已刪除版本：{versions}',
    versionRecycleNothingRemoved: '沒有版本被刪除',
    versionRecycleKeptTitle: '保留的版本及原因',
    instancesTitle: '實例',
    instancesEmpty: '暫無實例',
    instanceHost: '本體',
    instanceClone: '分身',
    instanceVersionNotStarted: '尚未啟動',
    versionFollowCurrent: '跟隨當前版本',
    versionPinnedOption: '釘在指定版本',
    versionPinned: '釘住 v{version}',
    versionSelectLabel: '選擇版本',
    versionSwitchNotice: '切換版本綁定會導致該實例停止再啟動。',
    versionSwitchSuccess: '版本綁定已更新',
    versionSwitchFailed: '版本綁定更新失敗：{message}',
    instanceRunning: '運行中',
    instanceStopped: '已停止',
    instanceActionOpen: '打開配置',
    instanceOpenUnavailable: '未能讀取 {name} 的插件信息，請刷新後重試',
    instanceColumnActions: '操作',
    instanceActionSwitchVersion: '切換版本',
    instanceActionLogLevel: '日誌等級',
    purgeScopeConfig: '設定',
    purgeScopePluginData: '外掛資料',
    purgeScopeOwnDatabase: '自有資料庫',
    purgeScopeDataDirectory: '資料目錄 config/plugins/{id}/',
    instanceActionReset: '重置配置與數據',
    instanceActionUninstallHost: '卸載插件及全部分身',
    instanceActionUninstallClone: '卸載此分身',
    instanceResetConfirm: '確定要重置 {name} 的配置與業務數據嗎？該實例的數據將被清空，且無法恢復。',
    instanceResetSuccess: '{name} 已重置',
    instanceResetFailed: '重置失敗：{message}',
    instanceUninstallTitle: '解除安裝 {name}',
    uninstallKeepsCloneSettings:
      '解除安裝後這個分身會從清單中移除，它的設定、顯示名稱與業務資料原樣保留；之後在「建立分身」裡可以依 ID 把它恢復回來。',
    uninstallKeepsHostSettings: '解除安裝會刪除外掛套件，但它的設定與業務資料原樣保留；重新安裝後設定會自動回來。',
    uninstallCascadeWarning: '它的分身（{clones}）會被一併解除安裝，各自的設定同樣保留。',
    uninstallAlsoPurgeTitle: '同時清除（選用）',
    uninstallAlsoPurgeHint: '預設一項都不清除。勾選的內容會被真正刪除，且無法透過恢復拿回。',
    uninstallPurgeIrreversible: '你勾選的內容將被永久刪除，恢復時不會再有它們。',
    uninstallConfirm: '解除安裝',
    uninstallAndPurgeConfirm: '解除安裝並清除',
    instanceUninstallSuccess: '{name} 已卸載',
    instanceUninstallFailed: '卸載失敗：{message}',
    cloneVersionStrategy: '版本策略',
    cloneModeCreate: '新建分身',
    cloneModeRestore: '恢復已解除安裝（{count}）',
    cloneRestoreHint: '挑一個之前解除安裝掉的分身，把它連同當時的設定一起拿回來。已在冊的分身不會出現在這裡。',
    cloneRestorableHasConfig: '留有設定',
    cloneRestorableHasData: '留有資料',
    cloneRestoreConfirm: '恢復該分身',
    cloneVersionFollow: '跟隨本體版本',
    cloneVersionAnchor: '錨定版本',
    cloneVersionAnchorUnavailable: '當前沒有可錨定的版本，分身只能跟隨本體版本。',
    cloneVersionNotInstalled: '未安裝',
    cloneVersionInstalled: '已安裝，可直接錨定',
    cloneVersionWillInstall: '未安裝，創建分身前會先安裝該版本',
    cloneVersionInstallNotice: '安裝 v{version} 會把插件的當前版本改為該版本，跟隨本體版本的實例會隨之切換。',
    cloneVersionInstallFailed: '版本 v{version} 安裝失敗：{message}，分身未創建',
    cloneVersionsLoadFailed: '讀取可錨定版本失敗',
    defaultTargetSet: '設為默認調用目標',
    defaultTargetClear: '取消默認調用目標',
    defaultTargetOnlyOneHint: '每個插件同一時間至多一個默認調用目標',
