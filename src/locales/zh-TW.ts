export default {
  ...
  music: {
    ...
    artistCollectionMode: '下載藝術家大合集',
    artistCollectionModeDescription: '只選擇並下載一個藝術家大合集；展開資源可核對其中確認包含的專輯、EP 和單曲。',
    artistCompletionMode: '補全缺失作品',
    artistCompletionModeDescription: '只列出媒體庫缺失的官方專輯、EP 和單曲；有精確資源的項目預設選中。',
    discographyLoadFailed: '載入藝術家作品失敗',
    artistCollectionResources: '藝術家合集資源',
    artistCollectionDescription: '按藝術家搜尋大合集種子；本模式一次只下載一個合集，不再混合提交逐張作品補全。',
    noArtistCollections: '沒有找到藝術家大合集',
    noArtistCollectionsDescription: '目前站點或搜尋詞沒有返回符合條件的大合集資源。',
    selectedCollectionCoverage: '選中合集確認覆蓋',
    viewCollectionWorks: '查看包含作品（{count}）',
    collectionWorksUnknown: '種子目錄中未能確認對應的官方專輯、EP 或單曲。',
    coverageConfirmed: '確認包含',
    coverageProbable: '可能包含',
    downloadArtistCollection: '下載大合集',
    downloadSelectedCollection: '下載選中大合集',
    downloadArtistCollectionConfirm: '確定使用預設下載器下載「{title}」嗎？',
    artistCollectionDownloadAdded: '藝術家合集已加入下載',
    artistCollectionTaskAdded: '藝術家大合集任務已建立：{id}',
    artistCompletionTaskAdded: '缺失作品補全任務已建立：{id}',
    downloadMissingWorks: '下載缺失作品',
    downloadMissingWorksConfirm: '將逐項下載選中的 {count} 個媒體庫缺失作品，是否繼續？',
    probingCollection: '正在解析種子檔案清單',
    confirmedCoverage: '已確認覆蓋 {count}/{total} 個官方作品',
    probableCoverage: '另有 {count} 個可能覆蓋',
    coveredByCollection: '已由選中合集覆蓋',
    selectArtistCollection: '選擇藝術家合集 {title}',
    collectionSelected: '已選為基線',
    useAsCollectionBaseline: '作為合集基線',
    createArtistAcquisition: '建立完整作品任務',
    artistAcquisitionConfirm: '將提交 {collection} 個合集和 {count} 個缺失補齊資源，是否繼續？',
    artistAcquisitionAdded: '藝術家完整作品任務已建立：{id}',
    artistAcquisitionFailed: '建立藝術家完整作品任務失敗',
  ...
  setting: {
    classification: {
      ...
      helpButton: '查看自動分類說明',
      helpTitle: '自動分類使用說明',
      helpDescription: '依照下面的順序完成設定、檢查和發佈。',
      helpClose: '知道了',
      help: {
        sections: {
          categories: {
      ...
      preview: {
        title: '分類結果預覽與命中說明',
        description: '搜尋並選擇一筆媒體資訊，查看它會被分到哪裡。預覽不會修改目前已發佈的規則。',
        run: '預覽分類結果',
        modeLabel: '使用哪套規則',
        draftPolicy: '目前編輯中的規則',
        activePolicy: '已發佈的規則',
        factsTitle: '媒體資訊',
        searchDescription: '不需要手動填寫欄位；搜尋後選擇媒體，系統會直接使用這筆媒體資訊進行預覽。',
        keyword: '搜尋媒體',
      ...
      impact: {
        title: '影響分析',
        description: '讀取近期下載和整理記錄對應的完整媒體資訊，比較目前規則與待發佈規則的結果。',
        ...
        analyze: '開始分析',
        scope:
          '最多比較 200 筆近期記錄並傳回 50 筆變更範例；無法取得詳情的記錄會單獨列出，分析不會移動檔案或修改歷史。',
        ...
        warningsTitle: '需要注意',
        emptyAnalysis: '尚未產生影響分析。點擊「開始分析」後查看近期記錄的比較結果。',
        uncategorized: '未分類',
      ...
      control: {
        title: '版本發佈與歷史',
        description: '發佈和回退都以目前版本為準；如果伺服器已被其他操作更新，本機草稿會保留，不會被覆寫。',
