export default {
  ...
  login: {
    ...
    loginWithOIDC: '使用 OIDC 登錄',
    oidcUnbound: '該 OIDC 賬號未綁定系統用戶，請先使用用戶名密碼登錄後綁定',
    oidcError: 'OIDC 認證失敗',
    userInactive: '用戶已被禁用',
    loggingIn: '正在登錄',
    pleaseWait: '請稍候...',
  ...
  user: {
    ...
    bindOidc: '綁定 OIDC 賬號',
    bindOidcSuccess: 'OIDC 賬號綁定成功',
    bindOidcFailed: 'OIDC 賬號綁定失敗',
    unbindOidc: '解綁 OIDC 賬號',
    confirmUnbindOidc: '確定要解綁 OIDC 賬號嗎？解綁後將無法使用 OIDC 登錄。',
    unbindOidcSuccess: 'OIDC 賬號解綁成功',
    unbindOidcFailed: 'OIDC 賬號解綁失敗',
  ...
  setting: {
    ...
    oidc: {
      ...
      disabledStatus: 'OIDC 登錄未啟用，請打開開關並填寫簽發者 URL 後保存',
      testConnection: '測試連接',
      ...
      guideStep5: '5. 已登錄用戶可在右上角菜單中綁定/解綁 OIDC 賬號',
    },
    words: {
