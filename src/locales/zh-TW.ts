export default {
  ...
  plugin: {
    ...
    restartRequiredBadgeHint: '原生依賴已更新，目前插件仍可使用，重啟 MoviePilot 後完整生效',
    restartRequiredTitle: '插件更新需重啟',
    restartRequiredDescription: '插件「{plugin}」的原生依賴已更新，重啟 MoviePilot 後完整生效',
    restartRequiredMultipleDescription: '{count} 個插件的原生依賴已更新，重啟 MoviePilot 後完整生效',
    viewRestartRequiredPlugins: '查看插件',
