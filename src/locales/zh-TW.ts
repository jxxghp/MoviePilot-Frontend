export default {
  ...
  githubToken: {
    ...
    description: '提高 GitHub API 限流額度，讓插件、資源和更新存取更穩定。',
    notConfigured: '尚未設定 GitHub Token，可以使用 GitHub 授權或手動填寫 PAT。',
    ...
    reauthorize: '重新授權',
    disconnect: '解除授權',
    needsReauthorization: 'GitHub Token 已失效或即將過期，請重新授權。',
    manualTitle: '手動填寫 Token',
    manualHint: '如果無法使用一鍵授權，也可以貼上 GitHub PAT；Token 只會保存在伺服器。',
    ...
    authTitle: '授權 GitHub',
    authSubtitle: '在 GitHub 頁面確認授權後，MoviePilot 會自動完成設定。',
    ...
    promptDescription: '設定後可提高 GitHub API 限流額度，讓插件和資源存取更穩定。',
    promptAction: '前往設定',
