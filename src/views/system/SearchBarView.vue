...
function getMenus(): NavMenu[] {
  let menus: NavMenu[] = []
  // 导航菜单
  SystemNavMenus.forEach(item => item && menus.push({
    title: item.title,
    icon: item.icon,
    to: item.to,
    header: item.header,
  ...
  // 各类标签页
  SettingTabs.forEach(item => item && menus.push({
    title: '设定 -> ' + item.title,
    icon: item.icon,
  ...
  SubscribeMovieTabs.forEach(item => item && menus.push({
    title: '电影 -> ' + item.title,
    icon: item.icon,
  ...
  SubscribeTvTabs.forEach(item => item && menus.push({
  ...
  PluginTabs.forEach(item => item && menus.push({
    title: '插件 -> ' + item.title,
    icon: item.icon,
